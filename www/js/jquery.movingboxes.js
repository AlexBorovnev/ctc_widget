...
;(function($){
	...
	$.movingBoxes = function(el, options){
		...
		base.updateArrows = function(cur){
			base.$left.toggleClass(o.disabled, (!o.wrap && cur === (base.adj +1)) || base.totalPanels <= 3);
			base.$right.toggleClass(o.disabled, (!o.wrap && cur === (base.totalPanels -1)) || base.totalPanels <= 3);
		};
